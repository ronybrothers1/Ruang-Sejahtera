  ...
  return (
    <div className="min-h-screen bg-neutral-100 text-brand-ink">
      ...
      <main className="mx-auto w-full max-w-4xl px-4 py-8 md:px-6 md:py-12">
        ...
        <div className="mt-7"><p className="eyebrow">{program.focus}</p><h1 className="mt-3 font-heading text-4xl font-extrabold tracking-tight md:text-5xl">Pengajuan {program.name}</h1><p className="mt-4 max-w-3xl leading-7 text-neutral-600">{program.summary} Isi data berdasarkan kondisi nyata agar tim dapat melakukan review dengan tepat.</p></div>
