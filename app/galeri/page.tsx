...
export default function GalleryPage() {
  const images = [sampleActivities[0].image, programs[1].image, programs[2].image, programs[3].image, sampleActivities[3].image, programs[0].image, programs[4].image, programs[5].image];
  return (
    <>
