    ...
    <div className="max-w-4xl">
      ...
      <form action="/api/admin/content" method="post" encType="multipart/form-data" className="mt-8 space-y-6 rounded-2xl border border-neutral-200 bg-white p-6 md:p-8">
        ...
        {config.collection === 'activities' ? <>
          ...
          <div className="grid gap-5 md:grid-cols-2">
            <label className="text-sm font-bold">Foto kegiatan <span className="font-normal text-neutral-500">(opsional)</span><input name="imageFile" type="file" accept="image/jpeg,image/png,image/webp" className="mt-2 block min-h-12 w-full rounded-xl border border-neutral-300 bg-white px-3 py-3 font-normal file:mr-3 file:rounded-lg file:border-0 file:bg-neutral-100 file:px-3 file:py-2 file:font-semibold" /><span className="mt-2 block text-xs font-normal text-neutral-500">JPG, PNG, atau WEBP. Maksimal 2 MB.</span></label>
