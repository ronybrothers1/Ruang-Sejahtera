...
export default async function NewContentPage({ params }: { params: Promise<{ type: string }> }) {
  ...
  return (
    <div className="max-w-4xl">
      ...
      {!cms.configured ? <div className="mt-7 rounded-xl border border-amber-200 bg-amber-50 p-5 text-sm leading-6 text-amber-900"><strong>Mode baca saja.</strong> Backend tulis CMS belum tersedia sehingga tombol simpan dinonaktifkan. Form ini tetap menunjukkan schema input produksi tanpa menyimpan data ke penyimpanan sementara.</div> : null}
