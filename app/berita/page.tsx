      ...
      <section className="trust-page-section trust-archive-section trust-archive-white">
        <div className="shell trust-news-archive">
          {items.map((item, index) => (
            <article id={index < sampleNews.length ? item.slug : undefined} className={index === 0 ? 'trust-news-archive-card trust-news-lead' : 'trust-news-archive-card'} key={`${item.slug}-${index}`}>
