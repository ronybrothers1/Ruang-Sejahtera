...
export const publicSearchIndex = [
  ...
  { title: 'Dampak', description: 'Data dampak yang telah diverifikasi dan sumber metodologinya.', href: '/dampak' },
  ...
  { title: 'Organisasi', description: 'Struktur organisasi dan pengurus berdasarkan data resmi.', href: '/organisasi' },
  { title: 'Kontak', description: 'Kanal komunikasi resmi yayasan.', href: '/kontak' },
